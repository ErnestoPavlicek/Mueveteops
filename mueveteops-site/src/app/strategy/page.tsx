...
export const metadata: Metadata = {
  title: "AI Strategy | MueveOps",
  description:
    "A free, no-strings review of your workflows — we'll show you where AI saves time, cuts costs, and improves quality.",
  alternates: {
    canonical: "/strategy",
  },
};
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-20">
          <Reveal className="lg:flex-1">
            <div className="flex flex-col gap-7 max-w-[58ch]">
              <SectionLabel>02 / Why AI Strategy?</SectionLabel>
              <h2 className="text-display-1 text-[var(--text-primary)]">
                Most teams chase{" "}
